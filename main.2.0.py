import sys
from PyQt5.QtWidgets import QApplication, QLabel, QPushButton, QVBoxLayout, QWidget, QFileDialog, QGridLayout ,QLineEdit ,QMessageBox,QRadioButton,QCalendarWidget,QTableWidget,QTableWidgetItem,QAbstractItemView
...
window.move(400,200)
window.setStyleSheet("background : #9AC6C5")
